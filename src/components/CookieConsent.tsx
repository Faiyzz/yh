...
export const CookieConsent = () => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-50 bg-zinc-900 border-t border-zinc-800 p-6 shadow-lg transition-all duration-500 font-sans ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="flex-1">
            <h3 className="text-white font-medium mb-2 tracking-[0.3em] text-sm lg:text-base">Cookie Preferences</h3>
