        ...
        <article className="prose prose-invert prose-lg md:prose-xl max-w-none text-gray-100 tracking-tight" style={{ fontFamily: "'Oswald', sans-serif" }}>
          <div className="w-full flex justify-center my-6">
            <div className="relative w-full md:w-2/3 aspect-video rounded-xl shadow-md overflow-hidden">
              <Image src={IMAGES[0].src} alt={IMAGES[0].alt} fill className="object-cover" sizes="(max-width: 768px) 100vw, 66vw" />
            </div>
          </div>

          <p className="font-normal text-gray-200">
            When a hurricane passes, Florida homeowners often face more damage than what&apos;s visible on the surface. Floodwaters bring hidden moisture, structural risks, and the rapid growth of mold — sometimes within 24 to 48 hours. <span className="font-semibold text-[#FFE241]">At Ridgeback Builders, we specialize in fast-response flood remediation and mold removal</span>, helping homeowners in Naples, Fort Myers, Port Charlotte, Sarasota, and other coastal communities recover safely and fully.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-4 mb-6">
            ...
            <div className="relative w-full md:w-1/3 aspect-[4/3] rounded-xl shadow-md overflow-hidden">
              <Image src={IMAGES[1].src} alt={IMAGES[1].alt} fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
            </div>
          </div>
          ...
          <div className="w-full flex justify-center my-5">
            <div className="relative w-full md:w-2/3 aspect-video rounded-xl shadow-md overflow-hidden">
              <Image src={IMAGES[2].src} alt={IMAGES[2].alt} fill className="object-cover" sizes="(max-width: 768px) 100vw, 66vw" />
            </div>
          </div>
          ...
          <ol className="list-decimal pl-6 font-normal text-gray-100">
            <li><span className="font-medium">Moisture Mapping & Thermal Imaging:</span> Using infrared cameras and moisture sensors, we identified water intrusion behind the walls and under the laminate flooring.</li>
            <li><span className="font-medium">Demolition & Material Removal:</span> We removed all compromised drywall 2 feet above the water line, vinyl flooring and wet subfloor, and mold-infested insulation.</li>
            <li><span className="font-medium">Industrial Drying & Dehumidification:</span> Deployed high-power air movers and commercial-grade dehumidifiers to dry the structure for 72 hours while monitoring humidity levels daily.</li>
            <li><span className="font-medium">Mold Remediation & Air Scrubbing:</span> Treated all affected surfaces with EPA-approved antimicrobials and ran HEPA filtration systems to remove airborne spores.</li>
            <li><span className="font-medium">Full Renovation & Restoration:</span> Rebuilt the drywall, installed waterproof luxury vinyl plank flooring, and repainted with mold-resistant interior paint.</li>
          </ol>

          <div className="w-full flex justify-center my-6">
            <div className="relative w-full md:w-2/3 aspect-video rounded-xl shadow-md overflow-hidden">
              <Image src={IMAGES[3].src} alt={IMAGES[3].alt} fill className="object-cover" sizes="(max-width: 768px) 100vw, 66vw" />
            </div>
          </div>
