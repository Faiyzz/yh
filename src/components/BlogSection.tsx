...
const blogPosts = [
  {
    ...
    excerpt: "Essential guide to protecting your home from hurricane damage and preventing mold growth in Florida's humid climate.",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "When to repair and when to replace your roof after hurricane damage - a comprehensive guide for Florida homeowners.",
    readTime: "6 min read",
    category: "Roofing",
  ...
  },
  {
    ...
    excerpt: "Transform your bathroom with Florida-specific considerations for humidity, materials, and design trends.",
  ...
  },
  {
    ...
    excerpt: "Create your dream kitchen while navigating Florida's unique building codes and climate considerations.",
  ...
  },
  {
    ...
    excerpt: "Maximize your outdoor living space with a custom kitchen addition designed for Florida's year-round outdoor lifestyle.",
    readTime: "9 min read",
  ...
  },
  {
    ...
    excerpt: "Learn to identify structural walls and understand the differences between metal studs vs wood studs in construction.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "Everything you need to know about installing a durable concrete driveway that withstands Florida weather.",
  ...
  },
  {
    ...
    excerpt: "Proper foundation techniques for outdoor structures in Florida's sandy soil and hurricane-prone environment.",
    readTime: "8 min read",
    category: "Concrete Work",
  ...
  },
  {
    ...
    excerpt: "Step-by-step guide to adding convenient access doors to your garage while maintaining structural integrity.",
    readTime: "6 min read",
    category: "Construction",
  ...
  },
  {
    ...
    excerpt: "Convert unused space into rental income with this comprehensive guide to creating legal rental units.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex items-center gap-4">
            <FileText className="h-8 w-8 md:h-8 md:w-8 lg:h-12 lg:w-12 text-[#FFE241]" />
            <h2
        ...
        >
          <Link href="/blog">
            <Button
              className="bg-[#FFE241] text-black hover:bg-[#FFE241]/90 font-bold px-8 py-3 text-lg"
              style={{ fontFamily: "'Trobus Expanded', sans-serif" }}
            >
              SEE ALL ARTICLES
            </Button>
